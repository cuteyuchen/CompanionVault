...
Show the user proposed SOUL conclusions, changed Skill references, memory candidates with source references, uncertain evidence, and excluded details. Unapproved memory remains private and must not be packaged.
